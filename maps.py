...
map4 = DrawMap(map4_layout, bg3, bg3, wall1, track2)
map5 = DrawMap(map5_layout, bg3, bg3, wall1, track2)
map6 = DrawMap(map6_layout, bg3, bg3, wall1, track2)
map_tuple = (map1, map2, map3, map4, map5, map6)
