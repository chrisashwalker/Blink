...
if __name__ == "__main__":
    ...
    while new_game:
        ...
        window.fill(BLACK)
        intro_text = text.render(intro2,
                                 True, WHITE)
        window.blit(intro_text, (intro_text_rect[0], intro_text_rect[1]))
        pygame.display.flip()
        time.sleep(4)
        window.fill(BLACK)
        intro_text = text.render(intro3, True, WHITE)
        window.blit(intro_text, (intro_text_rect[0], intro_text_rect[1]))
        pygame.display.flip()
        time.sleep(5)
        window.fill(BLACK)
        intro_text = text.render(intro4, True, WHITE)
        window.blit(intro_text, (intro_text_rect[0], intro_text_rect[1]))
        pygame.display.flip()
        time.sleep(5)
        window.fill(BLACK)
        intro_text = text.render(intro5, True, WHITE)
        window.blit(intro_text, (intro_text_rect[0], intro_text_rect[1]))
        pygame.display.flip()
        time.sleep(6)
        window.fill(BLACK)
        intro_text = text.render(intro6, True, WHITE)
        window.blit(intro_text, (intro_text_rect[0], intro_text_rect[1]))
        pygame.display.flip()
        time.sleep(6)
        window.fill(BLACK)
        intro_text = text.render(intro7, True, WHITE)
        window.blit(intro_text, (intro_text_rect[0], intro_text_rect[1]))
        pygame.display.flip()
        time.sleep(2)
        window.fill(BLACK)
        intro_text = text.render(intro8, True, WHITE)
        window.blit(intro_text, (intro_text_rect[0], intro_text_rect[1]))
        pygame.display.flip()
        time.sleep(4)
        window.fill(BLACK)
        intro_text = text.render(intro9, True, WHITE)
        window.blit(intro_text, (intro_text_rect[0], intro_text_rect[1]))
        pygame.display.flip()
        time.sleep(3)
        window.fill(BLACK)
        intro_text = text.render(intro10, True, WHITE)
        window.blit(intro_text, (intro_text_rect[0], intro_text_rect[1]))
        pygame.display.flip()
        time.sleep(3)
        window.fill(BLACK)
        intro_text = text.render(intro11, True, WHITE)
        window.blit(intro_text, (intro_text_rect[0], intro_text_rect[1]))
        pygame.display.flip()
        time.sleep(6)
        window.fill(BLACK)
        intro_text = text.render(intro12, True, WHITE)
        window.blit(intro_text, (intro_text_rect[0], intro_text_rect[1]))
        pygame.display.flip()
        time.sleep(7)
        window.fill(BLACK)
        intro_text = text.render(intro13, True, WHITE)
        window.blit(intro_text, (intro_text_rect[0], intro_text_rect[1]))
        pygame.display.flip()
        time.sleep(3)
        window.fill(BLACK)
        intro_text = text.render(intro14, True, WHITE)
        window.blit(intro_text, (intro_text_rect[0], intro_text_rect[1]))
        pygame.display.flip()
        time.sleep(5)
        window.fill(BLACK)
        intro_text = text.render(intro15, True, WHITE)
        window.blit(intro_text, (intro_text_rect[0], intro_text_rect[1]))
        pygame.display.flip()
        time.sleep(4)
        window.fill(BLACK)
